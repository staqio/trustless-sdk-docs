...
class [ChangeCardBalanceParams](index.md)(accountNumber: String, amount: Double, currency: String) : [JSONParamsBuilder](../../com.trustless.params/-j-s-o-n-params-builder/index.md)
