//[trustless](../../../index.md)/[com.trustless.requests.kyc.retrieveUserStatus](../index.md)/[RetrieveUserStatusResponse](index.md)/[RetrieveUserStatusResponse](-retrieve-user-status-response.md)
