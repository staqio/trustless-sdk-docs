//[trustless](../../../index.md)/[com.trustless.requests.kyc.retrieveSteps.steps.fields](../index.md)/[KYCBooleanField](index.md)

# KYCBooleanField

[kotlin]\
class [KYCBooleanField](index.md) : [KYCBaseField](../-k-y-c-base-field/index.md)
...
| Name | Summary |
|---|---|
| [getValueBoolean](get-value-boolean.md) | [kotlin]<br>fun [getValueBoolean](get-value-boolean.md)(): Boolean<br>Returns field value |
| [isValid](is-valid.md) | [kotlin]<br>open override fun [isValid](is-valid.md)(): Boolean<br>if the current field has valid data |
| [putValueBoolean](put-value-boolean.md) | [kotlin]<br>fun [putValueBoolean](put-value-boolean.md)(value: Boolean)<br>Sets a new field value |
