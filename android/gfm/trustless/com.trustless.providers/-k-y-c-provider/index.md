...
| [getDeviceStatus](get-device-status.md) | [kotlin]<br>abstract suspend fun [getDeviceStatus](get-device-status.md)(): [GetDeviceStatusResponse](../../com.trustless.requests.kyc.deviceStatus/-get-device-status-response/index.md) |
| [getKycStatus](get-kyc-status.md) | [kotlin]<br>abstract suspend fun [getKycStatus](get-kyc-status.md)(): [RetrieveKycStatusResponse](../../com.trustless.requests.kyc.retrieveKycStatus/-retrieve-kyc-status-response/index.md) |
...
| [uploadNusukKyc](upload-nusuk-kyc.md) | [kotlin]<br>abstract suspend fun [uploadNusukKyc](upload-nusuk-kyc.md)(params: [CreateKycNusuk](../../com.trustless.requests.kyc.createKyc/-create-kyc-nusuk/index.md)): [CreateKycResponse](../../com.trustless.requests.kyc.createKyc/-create-kyc-response/index.md) |
