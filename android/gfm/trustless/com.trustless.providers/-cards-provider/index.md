...
| Name | Summary |
|---|---|
| [activateCard](activate-card.md) | [kotlin]<br>abstract suspend fun [activateCard](activate-card.md)(token: String, last4Digits: String): [StaqChangeCardStatusResponse](../../com.trustless.requests.cards/-staq-change-card-status-response/index.md) |
...
| [getCardPin](get-card-pin.md) | [kotlin]<br>abstract suspend fun [getCardPin](get-card-pin.md)(token: String): String<br>Pin of the card |
