//[trustless](../../../index.md)/[com.trustless.providers](../index.md)/[CardsProvider](index.md)/[getCardPin](get-card-pin.md)

# getCardPin

[kotlin]\
abstract suspend fun [getCardPin](get-card-pin.md)(token: String): String
